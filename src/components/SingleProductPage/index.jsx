          ...
          <div className="single-product-wrapper w-full ">
            ...
            >
              <div className="tab-buttons w-full mb-10 mt-5 sm:mt-0">
                <div className="container-x mx-auto">
                  <ul className="flex space-x-12 gap-4" dir="rtl">
                    <li>
                      <span
                        onClick={() => setTab("des")}
              ...
              <div className="tab-contents w-full " dir="rtl">
                <div className="container-x mx-auto">
                  {tab === "des" && (
                    <>
              ...
              <div className="related-product w-full bg-white">
                <div className="container-x mx-auto">
                  <div className="w-full py-[60px]">
                    <h1 className="sm:text-3xl text-xl font-600 text-qblacktext leading-none mb-[30px]" dir="rtl">
