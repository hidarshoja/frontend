     ...
     >
      <div className="container-x mx-auto h-full">
        <div className="w-full h-full relative">
          ...
          <div className="w-full h-full flex justify-between items-center flex-row-reverse">
            <div className="category-and-nav flex flex-row-reverse gap-4 xl:rtl:space-x-reverse space-x-7 rtl:space-x-reverse space-x-3 items-center">
              <div className="category w-[270px] h-[53px] bg-white px-5 rounded-t-md mt-[6px] relative">
                ...
                >
                  <ul className="categories-list relative" dir="rtl">
                    {categoryList &&
                          ...
                          >
                            <a rel="noopener noreferrer">
                              <div className=" flex justify-between items-center  px-5 h-10 transition-all duration-300 ease-in-out cursor-pointer">
                                <div className="flex items-center gap-1 rtl:space-x-reverse space-x-6">
                                  <span>
                                    <FontAwesomeCom
                                      className="w-4 h-4"
                                      icon={item.icon}
                                  ...
                                  <span className="text-xs font-400" dir="rtl">
                                    {item.name}
