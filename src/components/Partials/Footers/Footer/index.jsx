...
export default function Footer({ settings }) {
  ...
  return (
    <footer className="footer-section-wrapper bg-white print:hidden" style={{direction:"rtl"}}>
      <div className="container-x block mx-auto pt-[56px]">
        ...
        <div className="lg:flex justify-between mb-[50px]">
          <div className="lg:w-[424px]  ml-0 w-full mb-10 lg:mb-0">
            <h1 className="text-[18] font-500 text-[#2F2F2F] mb-5">درباره ما </h1>
            <p className="text-[#9A9A9A] text-[15px] w-[247px] leading-[28px]">
              {/* {footerContent && footerContent.about_us} */}
              یک خرید اینترنتی مطمئن،
               نیازمند فروشگاهی است که بتواند کالاهایی متنوع، باکیفیت و دارای قیمت مناسب را در مدت زمانی کوتاه به 
              دست مشتریان خود برساند و ضمانت بازگشت کالا هم داشته باشد؛     
