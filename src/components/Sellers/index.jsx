...
function Sallers({ sellersData }) {
  ...
  return (
    <>
      ...
      <div className="content-wrapper w-full mb-[60px]" dir="rtl">
                      ...
                      <div className="flex flex-col justify-between h-full">
                        <div className="">
                          ...
                          <div className="saller-text-details">
                            <ul>
                              <li className="text-black flex space-x-5 rtl:space-x-reverse items-center leading-9 text-base font-normal gap-2">
                                <span>
                                  <svg
                                    width="16"
                                    height="12"
