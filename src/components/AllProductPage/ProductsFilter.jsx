      ...
      >
        <div className="filter-subject-item pb-10 border-b border-qgray-border">
          <div className="subject-title mb-[30px]">
            <h1 className="text-black text-base font-500" style={{direction:"rtl"}}>
              {/* {ServeLangItem()?.Product_categories} */}
              لیست محصولات 
            </h1>
          </div>
          <div className="filter-items"  dir="rtl">
            <ul>
              {categories &&
                categories.length > 0 &&
        ...
        <div className="filter-subject-item pb-10 border-b border-qgray-border mt-10">
          ...
          {volume && (
            <>
              ...
              <p className="text-xs text-qblack font-400" dir="rtl">
                {/* {ServeLangItem()?.Price} */}
                قیمت 
                : تومان {volume.min} - تومان {volume.max}
              </p>
            </>
          )}
        </div>
