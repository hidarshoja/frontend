  ...
  return (
    <div className={`section-wrapper w-full ${className || ""}`}>
      <div className="container-x mx-auto">
        <div className=" section-title flex justify-between items-center mb-5 flex-row-reverse">
          <div>
        ...
        <div className="section-content" style={{direction:"rtl"}}>{children && children}</div>
      </div>
    </div>
  );
}
