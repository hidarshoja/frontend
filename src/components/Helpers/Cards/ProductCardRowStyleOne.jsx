    ...
    <div className="main-wrapper-card relative">
      ...
      >
          ...
          <div className="flex-1 flex flex-col justify-center h-full">
            <div>
              ...
              <p className="price mb-[26px]">
                ...
                >
                  {offerPrice ? (
                    <span>{currency_icon &&   Number(price).toLocaleString() }</span>
                  ) : (
                    <>
        ...
        {quickViewModal && quickViewData && (
          <div className="quicke-view-wrapper w-full h-full flex fixed left-0 top-0 justify-center z-50 items-center " dir="ltr">
            <div
