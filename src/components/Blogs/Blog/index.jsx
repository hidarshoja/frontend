      ...
      <div className="blog-page-wrapper w-full">
        ...
        <div className="content-area w-full">
          <div className="container-x mx-auto">
            <div className="blog-article lg:flex lg:space-x-[30px] rtl:space-x-reverse mb-7 " dir="rtl" style={{gap:"10px"}}>
                  ...
                  <div className="comment-area w-full mt-8">
                    <div className="w-full sm:flex justify-between items-center mb-8">
                      ...
                      <div className="tags flex space-x-5 rtl:space-x-reverse items-center">
                        <span className="text-2xl text-qblack">اشتراک گذاری:</span>
                ...
                >
                  ...
                  <div className="w-full h-[60px] relative">
                    <input
                      ...
                      className="w-full h-full bg-[#F9F3E9] focus:outline-none focus:ring-0  pr-3 placeholder:text-qgraytwo"
                      dir="rtl"
                    />
                    <span className="absolute right-[17.25rem] top-[17px]">
                      <svg
                        width="25"
                        height="25"
                        viewBox="0 0 25 25"
                  ...
                  <div className="w-full h-full p-[30px] bg-black bg-opacity-75 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-base text-white leading-[26px] line-clamp-2">
                        ...
                        خبرنامه ما را دنبال کنید تا درباره ما به‌روزرسانی شده_بمانید
                        .
                      </p>
                    </div>
                    <div>
