        ...
        <div className="aboutus-wrapper w-full py-10">
          <div className="container-x mx-auto">
            <div className="w-full min-h-[665px] lg:flex lg:space-x-12 rtl:space-x-reverse items-center pb-10 lg:pb-0">
              ...
              <div className="content flex-1" dir="rtl">
            ...
            <SimpleSlider selector={slider} settings={settingTestimonial}>
              {aboutData.testimonials.length > 0 &&
                aboutData.testimonials.map((item, i) => (
                  ...
                  >
                    <div className="">
                      <div className="rating flex space-x-1 rtl:space-x-reverse items-center mb-4" dir="rtl">
                      ...
                      <div className="text-[15px] text-qgraytwo leading-[30px]  line-clamp-6 mb-4" dir="rtl">
                        {item.comment}
                      </div>
                      <div className="flex items-center space-x-2.5 rtl:space-x-reverse mt-3 justify-between">
