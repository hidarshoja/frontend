        ...
        <div className="container-x mx-auto">
          <div className="main-wrapper w-full lg:flex lg:space-x-[30px] rtl:space-x-reverse">
            <div className="lg:w-1/2 w-full">
              {datas.contact && (
                <div>
                  <h1 className="text-[22px] font-semibold text-qblack leading-[30px] mb-1" style={{direction:"rtl"}}>
                    {/* {datas.contact.title} */}
                    اطلاعات تماس
                  </h1>
                  <p className="text-[15px] text-qgraytwo leading-[30px] mb-5" style={{direction:"rtl"}}>
                    {/* {datas.contact.description} */}
                    فرم زیر را پر کنید یا برای ما بنویسید. ما در اسرع وقت به شما کمک خواهیم کرد.
                  </p>
                    ...
                    <div className="flex space-x-5 rtl:space-x-reverse">
                      ...
                      <div className="w-full"  style={{direction:"rtl"}}>
                        ...
                        <p className="text-[15px] text-qblack leading-[30px]">
                          ...
                          استان خراسان شمالی ، شهرستان بجنورد ، خیابان امامی 
            ...
            <div className="flex-1 bg-white sm:p-10 p-3">
              ...
              <div className="inputs mt-5" style={{direction:"rtl"}}>
                <div className="mb-4">
                  <InputCom
                    label={ "نام"}
