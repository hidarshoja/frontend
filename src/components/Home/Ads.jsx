            ...
            >
              <div className="w-[420px]" dir="rtl">
                ...
                <p className="text-qgray md:w-[480px] w-full md:text-base text-sm">
                  ...
                  از طرح جشنواره تخفیفات ما بهرمند شوید تا بتوانید در خرید های خود تخفیفات خوبی دریافت کنید 
                </p>
              </div>

              <div className="md:w-[415px] w-full h-[54px] sm:flex mt-8" dir="rtl">
                <div className="flex-1 bg-white ltr:pl-4 rtl:pr-4 mb-2 md:mb-0 flex space-x-2 rtl:space-x-reverse items-center h-full focus-within:text-qgreen text-qblack overflow-hidden" dir="rtl">
                  <span>
                    <svg
                      width="17"
                      height="15"
