          ...
          <div className="lg:flex xl:space-x-[30px] lg:space-x-5 rtl:space-x-reverse items-center h-full">
            ...
            >
              <div className="w-full xl:p-12 p-5">
                <div className="countdown-wrapper w-full flex lg:justify-between justify-evenly lg:mb-10 mb-2" style={{direction:"rtl"}}>
            ...
            >
              <div className="flex flex-col h-full justify-between">
                ...
                <p className="text-[13px] font-600 text-qblack mb-3" style={{direction:"rtl"}}>
                    {/* {ServeLangItem()?.MOBILE_APP_VERSION} */}
                    نسخه برنامه تلفن همراه
                  </p>
                  <h1 className="lg:text-[30px] text-2xl font-600 text-qblack leading-10 mb-8" style={{direction:"rtl"}}>
                    ...
                    <br />
                     {/* {ServeLangItem()?.Its_Make_easy_for_you_life} */}
                     این زندگی را برای شما آسان می کند 
                  </h1>
